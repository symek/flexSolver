 ...
 -DVERSION=\"15.0.376\" -D_GNU_SOURCE -DLINUX -DAMD64 -m64 -fPIC -DSIZEOF_VOID_P=8 -DFBX_ENABLED=1 -DOPENCL_ENABLED=1 \
 -DOPENVDB_ENABLED=1 -DSESI_LITTLE_ENDIAN -DENABLE_THREADS -DUSE_PTHREADS -D_REENTRANT -D_FILE_OFFSET_BITS=64 -c \
 -I/home/symek/work/flex/core -I/home/symek/packages/cuda/7.5.18/platform-linux/arch-x86_64/include \
 -I/home/symek/work/flex/include  -DGCC4 -DGCC3 -Wno-deprecated -std=c++11 -isystem /opt/hfs15.0.376/toolkit/include \
 ...
 g++ src/fur.o -lpthread -o ./fur -L /opt/hfs15.0.376/dsolib -lHoudiniUI -lHoudiniOPZ -lHoudiniOP3 -lHoudiniOP2 \
 -lHoudiniOP1 -lHoudiniSIM -lHoudiniGEO -lHoudiniPRM -lHoudiniUT -lboost_system -L/usr/X11R6/lib64 -L/usr/X11R6/lib \
 -I/home/symek/work/flex/core -I/home/symek/packages/cuda/7.5.18/platform-linux/arch-x86_64/include \
 -I/home/symek/work/flex/include -L/home/symek/packages/cuda/7.5.18/platform-linux/arch-x86_64/lib64 -ldl -lcudart \
 -lGLU -lGL -lX11 -lXext -lXi -ldl -Wl,-rpath,/opt/hfs15.0.376/dsolib /home/symek/work/flex/core/maths.o  \
